...
namespace CountryByCountryReportV2
{
    public static class EnumLookup
    {
        ...
        public static CbcSummaryListElementsType_EnumType GetCbcSummaryListElementsType_EnumType(string cbcSummaryListElementsType_EnumType)
        {
            return (CbcSummaryListElementsType_EnumType)Enum.Parse(typeof(CbcSummaryListElementsType_EnumType), cbcSummaryListElementsType_EnumType);
        }
